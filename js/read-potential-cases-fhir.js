...
(async () => {
  ...
  await fs.writeFile("anterior-and-intermediate-uveitis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("anterior-and-intermediate-uveitis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
